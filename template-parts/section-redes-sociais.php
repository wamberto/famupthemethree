<section class="container-fluid bg-light" id="redes-sociais">
    <div class="container text-center py-5">
        <p class="h4 text-primary mb-4">Fale com a gente nas redes</p>
            <ul class="list-inline">
                <li class="list-inline-item icones facebook">
                  <a href="https://www.facebook.com/famup1" target="_blank" class=""><i class="bi bi-facebook"></i></a>
                </li>
